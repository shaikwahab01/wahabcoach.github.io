...
ScrollReveal().reveal('.home-content, .heading', { origin: 'top' });
 ScrollReveal().reveal('.home-img, .services-container, .devops-career-box,', { origin: 'bottom' });
 ScrollReveal().reveal('.reviews h1,p,h2 reviews-contanier  ', { origin: 'top' });
 ScrollReveal().reveal('.guided-content h2 ', { origin: 'top' });
 ScrollReveal().reveal('.membership, h1.membership-box h3,li,img ', { origin: 'top' });
